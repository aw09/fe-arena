...
/**
     ...
     * See the License for the specific language governing permissions and
     * limitations under the License.
     */function Ds(e,t,n,i,s){const r=new Ps;let o,a;if(n.type===ji.OVERWRITE){const l=n;l.source.fromUser?o=Fs(e,t,l.path,l.snap,i,s,r):(z(l.source.fromServer,"Unknown source."),a=l.source.tagged||t.serverCache.isFiltered()&&!qn(l.path),o=Os(e,t,l.path,l.snap,i,s,a,r))}else if(n.type===ji.MERGE){const l=n;l.source.fromUser?o=function(e,t,n,i,s,r,o){let a=t;return i.foreach(((i,l)=>{const h=Ln(n,i);Ms(t,Rn(h))&&(a=Fs(e,a,h,l,s,r,o))})),i.foreach(((i,l)=>{const h=Ln(n,i);Ms(t,Rn(h))||(a=Fs(e,a,h,l,s,r,o))})),a}(e,t,l.path,l.children,i,s,r):(z(l.source.fromServer,"Unknown source."),a=l.source.tagged||t.serverCache.isFiltered(),o=qs(e,t,l.path,l.children,i,s,a,r))}else if(n.type===ji.ACK_USER_WRITE){const a=n;o=a.revert?function(e,t,n,i,s,r){let o;if(null!=Es(i,n))return t;{const a=new Rs(i,t,s),l=t.eventCache.getNode();let h;if(qn(n)||".priority"===Rn(n)){let n;if(t.serverCache.isFullyInitialized())n=ws(i,ts(t));else{const e=t.serverCache.getNode();z(e instanceof vi,"serverChildren would be complete if leaf node"),n=bs(i,e)}h=e.filter.updateFullNode(l,n,r)}else{const s=Rn(n);let c=ks(i,s,t.serverCache);null==c&&t.serverCache.isCompleteForChild(s)&&(c=l.getImmediateChild(s)),h=null!=c?e.filter.updateChild(l,s,c,An(n),a,r):t.eventCache.getNode().hasChild(s)?e.filter.updateChild(l,s,vi.EMPTY_NODE,An(n),a,r):l,h.isEmpty()&&t.serverCache.isFullyInitialized()&&(o=ws(i,ts(t)),o.isLeafNode()&&(h=e.filter.updateFullNode(h,o,r)))}return o=t.serverCache.isFullyInitialized()||null!=Es(i,xn()),Xi(t,h,o,e.filter.filtersNodes())}}
/**
     * @license
     * Copyright 2017 Google LLC
     *
...
/**
     ...
     * limitations under the License.
     */
class Kr{constructor(){this.eventLists_=[],this.recursionDepth_=0}}function Gr(e,t){let n=null;for(let i=0;i<t.length;i++){const s=t[i],r=s.getPath();null===n||Un(r,n.path)||(e.eventLists_.push(n),n=null),null===n&&(n={events:[],path:r}),n.events.push(s)}n&&e.eventLists_.push(n)}function Qr(e,t,n){Gr(e,n),Xr(e,(e=>Un(e,t)))}function Jr(e,t,n){Gr(e,n),Xr(e,(e=>Wn(e,t)||Wn(t,e)))}function Xr(e,t){e.recursionDepth_++;let n=!0;for(let i=0;i<e.eventLists_.length;i++){const s=e.eventLists_[i];if(s){t(s.path)?(Zr(e.eventLists_[i]),e.eventLists_[i]=null):n=!1}}n&&(e.eventLists_=[]),e.recursionDepth_--}function Zr(e){for(let t=0;t<e.events.length;t++){const n=e.events[t];if(null!==n){e.events[t]=null;const i=n.getEventRunner();Ft&&Lt("event: "+n.toString()),en(i)}}}
/**
     * @license
     * Copyright 2017 Google LLC
     *
